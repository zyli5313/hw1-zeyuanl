...
public class SourceDocInfo_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.lti.cmu.hw1.typesys.SourceDocInfo");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "edu.lti.cmu.hw1.typesys.SourceDocInfo");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "edu.lti.cmu.hw1.typesys.SourceDocInfo");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "edu.lti.cmu.hw1.typesys.SourceDocInfo");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "edu.lti.cmu.hw1.typesys.SourceDocInfo");
